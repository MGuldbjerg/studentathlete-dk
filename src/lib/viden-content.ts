...
export const VIDEN_GUIDES: VidenGuide[] = [
  {
    ...
    sources: [
      { label: "NCAA.org — Rekordmange student-athletes i 2024-25", url: "https://www.ncaa.org/news/2025/9/15/media-center-a-record-number-of-ncaa-student-athletes-participated-in-2024-25.aspx" },
      { label: "NCAA.org — Om NCAA og medlemskab", url: "https://www.ncaa.org/sports/2021/2/10/about-resources-media-center-ncaa-101-what-ncaa.aspx" },
      { label: "ESPN — Dommer godkender House-forliget (direkte betaling af atleter)", url: "https://www.espn.com/college-sports/story/_/id/45467505/judge-grants-final-approval-house-v-ncaa-settlement" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Our Three Divisions", url: "https://www.ncaa.org/sports/2021/2/10/about-resources-media-center-ncaa-101-our-three-divisions.aspx" },
      { label: "Ropes & Gray — House-forliget: æra med direkte betaling begynder", url: "https://www.ropesgray.com/en/insights/alerts/2025/06/house-v-ncaa-settlement-approved-era-of-direct-payments-to-college-athletes-begins" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "Wikipedia — Power conferences (Power Four)", url: "https://en.wikipedia.org/wiki/Power_conferences" },
      { label: "Front Office Sports — Power 5-æraen er forbi", url: "https://frontofficesports.com/conference-realignment-end-of-power-5-end/" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NAIA — officiel hjemmeside", url: "https://www.naia.org/" },
      { label: "NJCAA — officiel hjemmeside", url: "https://www.njcaa.org/" },
      { label: "ESPN — NCAA giver dispensation til tidligere JUCO-spillere (Pavia)", url: "https://www.espn.com/college-football/story/_/id/43131557/ncaa-division-board-grants-waiver-former-juco-players-appealing-diego-pavia-injunction" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Akademiske standarder og krav", url: "https://www.ncaa.org/sports/2014/10/6/academic-standards.aspx" },
      { label: "NCAA — Eligibility Center (academic requirements)", url: "https://www.ncaa.org/sports/2018/7/11/eligibility-center.aspx" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.com — Mesterskabskalender og datoer", url: "https://www.ncaa.com/" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "Higher Ed Dive — NCAA fjerner permanent SAT/ACT-krav (D-I og D-II)", url: "https://www.highereddive.com/news/ncaa-permanently-ends-sat-act-eligibility-requirement-division-i-ii/642117/" },
      { label: "NCAA — Eligibility Center", url: "https://www.ncaa.org/sports/2018/7/11/eligibility-center.aspx" },
      { label: "Ropes & Gray — House-forliget og direkte betaling af atleter", url: "https://www.ropesgray.com/en/insights/alerts/2025/06/house-v-ncaa-settlement-approved-era-of-direct-payments-to-college-athletes-begins" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Division I Council godkender ændrede transferregler (april 2024)", url: "https://www.ncaa.org/news/2024/4/17/media-center-division-i-council-approves-changes-to-transfer-rules.aspx" },
      { label: "ESPN — NCAA godkender umiddelbar spilleberettigelse ved transfer", url: "https://www.espn.com/college-football/story/_/id/39963389/ncaa-approves-new-transfer-rule-allowing-immediate-eligibility" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Division I vedtager aldersbaseret eligibility-model (juni 2026)", url: "https://www.ncaa.org/news/2026/6/23/media-center-division-i-adopts-age-based-eligibility-model.aspx" },
      { label: "CBS Sports — NCAA godkender aldersbaseret femårsregel", url: "https://www.cbssports.com/college-football/news/ncaa-five-year-eligibility-rule-college-football-basketball/" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Glossary / NCAA 101", url: "https://www.ncaa.org/sports/2021/2/10/about-resources-media-center-ncaa-101-what-ncaa.aspx" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "NCAA.org — Turneringerne udvides til 76 hold", url: "https://www.ncaa.org/sports/2026/5/7/ncaa-basketball-tournaments-expanding-to-76-teams-what-to-know.aspx" },
      { label: "NCAA.com — Sådan fungerer den udvidede 2027-turnering", url: "https://www.ncaa.com/news/basketball-men/article/2026-05-07/how-2027-expanded-ncaa-tournament-and-march-madness-brackets-will-work" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "Wikipedia — College Football Playoff (format og historik)", url: "https://en.wikipedia.org/wiki/College_Football_Playoff" },
      { label: "Sports Illustrated — CFP forbliver 12 hold i 2026", url: "https://www.si.com/college-football/playoffs/cfp-makes-decision-expansion-2026" },
    ],
    updated: UPDATED,
  },
  {
    ...
    sources: [
      { label: "ESPN — NCAA godkender afskaffelse af NLI-programmet", url: "https://www.espn.com/college-sports/story/_/id/41702974/ncaa-approves-elimination-national-letter-intent-program" },
      { label: "NCSA — NCAA afskaffer NLI: hvad nu?", url: "https://www.ncsasports.org/blog/ncaa-eliminates-nli" },
    ],
    updated: UPDATED,
  },
];
