...
const ui: LanguagePack["ui"] = {
  ...
  "feed.description": "Coverage of student athletes from {country} competing in the United States",
  "ads.disclosure": "Advertisement · {brand} may earn a commission if you buy through this link.",
  "ads.customs": "Shipped from the United States — customs and VAT may be charged on delivery to the {country}.",
  "time.now": "Just now",
