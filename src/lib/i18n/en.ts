...
const ui: LanguagePack["ui"] = {
  ...
  "footer.family": "Part of the StudentAthlete family",
  ...
  "archive.older": "Older →",
  "card.versus": "vs",
  "card.outcome_win": "Win",
  "card.outcome_loss": "Loss",
  "card.outcome_tie": "Tie",
  ...
  "ads.customs": "Shipped from the United States — customs and VAT may be charged on delivery.",
  "time.now": "Just now",
  ...
  "profile.honours_note": "Honours as the school itself lists them on the athlete's own profile page.",
  "cookies.banner": "We use necessary cookies to make the site work. With your consent we also use cookies for advertising. Read more in our ",
