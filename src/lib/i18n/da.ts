...
const ui: LanguagePack["ui"] = {
  ...
  "profile.honours_note": "Udmærkelser som skolen selv oplyser på atletens profilside.",
  "cookies.banner": "Vi bruger nødvendige cookies, for at sitet fungerer. Med din accept bruger vi også cookies til annoncer. Læs mere i vores ",
  "cookies.policy_link": "cookiepolitik",
  "cookies.necessary_only": "Kun nødvendige",
  "cookies.accept_all": "Accepter alle",
  "cookies.settings": "Cookieindstillinger",
  "article.source": "Kilde",
  "article.season": "Sæson {season}",
  "athletes.intro":
