...
Until 2025 a Division I FBS team could award 85 full football scholarships. After the House settlement that cap is gone at the schools that opted in, replaced by an overall **squad limit of 105 players**, all of whom may in principle be funded. The classic unfunded walk-on is therefore on the way out — nobody is formally banned, but every place now counts against the limit. Eligibility itself has been reworked too: the old "four seasons within five years" and the redshirt arrangement are gradually giving way to an age-based model. See [redshirt and eligibility](/guides/redshirt-and-eligibility).

105 is the largest squad limit in college sport, and it is still a limit. A kicker does not compete with 104 others for his place, but with the two or three other specialists on the card. Outside the settlement schools, in Division II and in the NAIA the old scholarship rules continue, and Division III awards no athletic scholarships — see [the divisions](/guides/ncaa-divisions).

### Conferences and independents

College football is split into two tiers within Division I, and the difference is larger than the names suggest: **FBS** is the one on television, with the bowl games and the College Football Playoff, while **FCS** has its own play-offs and fewer scholarships. Below that, Division II, Division III and the NAIA all play football with championships of their own.

Conference membership has moved dramatically in recent years, as television deals have pulled schools across the country into new conferences — a university on the west coast may now play in a conference whose other members sit in the middle of the country. For a player that means travel and late kick-offs. Football also has American sport's most famous **independent**: Notre Dame plays without a conference in football, with its own television deal and its own schedule, while the university's other teams compete in an ordinary conference. It is the clearest illustration of the rule that conference membership follows the sport, not the school.
...
The national tournament is a straight knockout played in weekend blocks over three weeks: lose once and you are out. Teams are seeded 1 to 16 across four regions, and every year a low seed — a "Cinderella" — beats the favourites. The rounds are called the Sweet Sixteen, the Elite Eight and the Final Four. The field has stood at 68 teams, but in 2026 the NCAA decided to expand both the men's and women's tournaments to 76 teams from the 2026-27 season.
...
- [NCAA. (2026, 7 May). NCAA basketball tournaments expanding to 76 teams: What to know.](https://www.ncaa.org/sports/2026/5/7/ncaa-basketball-tournaments-expanding-to-76-teams-what-to-know.aspx)
...
College baseball is played with aluminium and composite bats (BBCOR-certified) rather than the wooden bats of the professional game. It gives the sport its own sound — a sharp ping instead of a crack — and a little more power, which makes college games high-scoring and fast.

### Scholarships and squad size

Baseball was historically the clearest example of an **equivalency sport**: a Division I programme divided just 11.7 scholarships across a squad of 30 or more, so a full award was rare and most players held a fraction of one. The House settlement changed that at the schools that opted in — the scholarship cap is gone, replaced by a **squad limit of 34 players**, all of whom may in principle be fully funded.

That is a large change in a sport notorious for thin funding, but it applies only to the schools inside the settlement. Elsewhere, and throughout Division II, the old equivalency arithmetic continues; Division III offers no athletic scholarships. See [the divisions](/guides/ncaa-divisions).

### Conferences and independents

Baseball's conference structure carries real weight because the season is so long: a team plays most of its schedule in weekend series against conference opponents, and the conference tournament in May decides an automatic place in the NCAA tournament. The rest of the field is selected nationally, and here geography tells — programmes in the warm south play outdoors from February and build stronger records than northern schools still waiting for the weather.

A handful of schools play baseball as independents, without a conference, and must assemble a schedule and earn an at-large place on results alone.
...
College soccer keeps rules that will surprise anyone raised on the British game. At most levels — the women's game and the lower divisions — a substituted player may return later in the match, and teams substitute far more freely than in Europe, which makes the game faster and more physical. Men's Division I abolished re-entry in 2024 to move closer to the FIFA laws. Drawn matches in the regular season may go to a short period of extra time, and in the play-offs everything is settled on penalties.
...
Although every event is an individual performance, it all adds up to a team contest through points. At a meet — whether a dual meet between two schools or a large invitational with many teams — points are awarded by finishing position in each event, and the school with the highest total wins. A broad squad scoring in many events therefore beats a team with a few big stars. Cross country inverts the arithmetic: there the **lowest** score wins, because the finishing positions of a team's first five runners are added together.

### Scholarships and squad size

Athletics carries a quirk worth understanding before reading any squad numbers: **cross country and track and field count as separate sports**, even though in practice they often involve the same athletes and the same coach. For the Division I schools that opted into the House settlement in 2025, the old scholarship caps are gone, replaced by a squad limit of **45 in track and field** and **17 in cross country** — and within that limit the school may fund whoever it chooses.

Forty-five sounds generous, and it is: athletics has one of the largest squad limits in college sport, because a team has to cover everything from 100 metres to the hammer. But it also means the award is almost always a **partial** one. Outside the settlement schools, and throughout Division II, the equivalency model applies as before — a single pot divided among many athletes — and Division III offers no athletic scholarships at all. Read [the divisions](/guides/ncaa-divisions) before comparing two offers.
...
Athletics has no draft. The route onward runs through results: a contract with a shoe company, selection for the national team, international meets, and for the best of them the Olympics. That makes the NCAA in effect the largest development system in world athletics, including for athletes who will never represent the United States. Because qualification is individual and the season is long and densely contested, a college athlete gets more serious competition in a year than most can arrange at home.
...
Swimming is one of the sports the House settlement hit hardest. At the Division I schools that opted in, the old scholarship caps are abolished and replaced by a **squad limit of 30 swimmers and divers combined** — a small number for a sport whose programme has to cover four strokes, every distance, relays and diving. Many American squads sat well above 30 and have had to cut. In return, the school may now fund all 30, where before it divided a restricted pot.

Outside the settlement schools and throughout Division II the equivalency model applies as before: one pot split into fractions, so a full award is rare and most swimmers combine athletic aid, academic scholarships and their own money. Division III offers no athletic scholarships. See [the divisions](/guides/ncaa-divisions).
...
Golf has one of the **smallest squad limits in college sport: 9 players** at the Division I schools that opted into the House settlement in 2025. The number follows from the format — five play, four scores count. Nine places means the competition for a spot stays brutal long after you have signed: the fifth place on the card has to be won again from event to event.

The flip side is that golf is one of the sports where a full scholarship is realistic, precisely because the money is divided among so few. Outside the settlement schools, and throughout Division II, the older equivalency model applies and awards are made in fractions; Division III offers no athletic scholarships but often substantial academic aid — a genuine route for a strong student with a low handicap. The differences are set out in [the divisions](/guides/ncaa-divisions).
...
Tennis shares with golf the smallest squad limit in college sport: **10 players** at the Division I schools that opted into the House settlement in 2025. With six singles and three doubles in every dual match, the whole squad is in play each time out — there is no bench to hide on. It is also why full scholarships are more common in tennis than in the large-squad sports: there are few places to divide the money between.

That is precisely why tennis is among the most internationally recruited sports in the NCAA. When a programme has ten places and needs to win six singles, it recruits on standard rather than geography, and it has been pulling European players across the Atlantic for decades. Outside the settlement schools and in Division II the equivalency model applies; Division III offers no athletic scholarships. See [the divisions](/guides/ncaa-divisions) for what that means in money.
...
There is no draft in tennis. The transition is a ranking matter: a player works up through ITF and challenger events, and the college years count against nothing. That makes college an unusually low-risk route in a sport whose alternative is travelling the world as a teenager at your own expense. Attitudes have shifted accordingly — the route is now entirely ordinary among players who later reach the ATP and WTA tours, and four years of funded coaching, physical development and match play is for many a better investment than four years in qualifying.
...
Rowing is geographically narrow, and that shapes its conference map: programmes cluster on the two coasts and around the Great Lakes, wherever there is water enough for a 2,000-metre course. Because many conferences do not sponsor rowing at all, a rowing programme often sits in a **different conference from the rest of its school**, and several of the strongest rowing schools compete in rowing-specific associations rather than their main conference. Access to the women's NCAA championship comes through both automatic places and at-large selection, so a fast programme without a conference title can still get there.

For the men, the IRA National Championship Regatta is what the NCAA final is for the women — the same prestige, a different governing body.
...
Gymnastics has a thin conference map, because so few schools sponsor it, and several teams compete in gymnastics-specific associations rather than their school's main conference. Access to the NCAA championship runs through regional meets and a national ranking of team scores across the season — not through the conference title alone.

That lets a strong team from a small conference reach the championship, and an individual gymnast qualify alone even when her team does not.
...
Three periods of 20 minutes, five skaters and a goaltender a side. College hockey is played on a North American rink, narrower than the European sheet — the game is tighter, heavier and settled faster along the boards, and that is the biggest technical adjustment for a European player. Regular-season ties go to overtime and a shoot-out under each conference's own rules.

### Scholarships and squad size

Ice hockey is an equivalency sport: scholarships have always been divisible into fractions, and most players have held a share rather than a full award. At the Division I schools that opted into the House settlement in 2025, the scholarship cap has given way to a **squad limit of 26 players**, within which the school may fund freely.

The number of Division I programmes is small — hockey is expensive and needs ice — so competition for a place is fierce, and most players come through junior hockey first. Outside the settlement schools and in Division II the old rules apply; Division III offers no athletic scholarships but sponsors a great many hockey programmes. See [the divisions](/guides/ncaa-divisions).
...
Six a side, best of five sets to 25 points (the fifth to 15). Rotation is the sport's signature: the team moves one place clockwise every time it wins the serve, so all six players have to function both at the net and in the back court. The exception is the libero, who wears a different shirt, plays only in the back court and may not attack over the net.

### Scholarships and squad size

Women's volleyball was historically a **headcount sport** in Division I: any scholarship counted as a whole one regardless of size, so in practice only full awards were made. After the House settlement in 2025 that system is gone at the schools that opted in, replaced by a **squad limit of 18 players** for both men and women, within which support may be divided freely.

Men's volleyball has far fewer programmes than the women's game and has always been an equivalency sport — partial awards are the norm there. Outside the settlement schools and in Division II the old rules apply, and Division III offers no athletic scholarships. See [the divisions](/guides/ncaa-divisions).

### Conferences and independents

Volleyball follows an ordinary conference pattern, with matches through the season and a conference tournament awarding an automatic place in the NCAA tournament. Worth knowing: **beach volleyball counts as a separate NCAA sport**, with its own championship and its own conferences. Many schools sponsor both and some players do both, but they are two different teams with two different seasons.

Because men's volleyball has so few programmes, its conference map is thin, and several men's teams compete in conferences unrelated to their school's other affiliations.
...
Division I has just over 80 programmes across roughly 33 conferences. Historically a D1 team could hold up to 12 full scholarships, usually split into partial awards, while Division II allowed up to 6.3. Those figures still govern the schools that did **not** opt into the House settlement, and Division II throughout.

At the Division I schools that did opt in, the scholarship caps were abolished in 2025 and replaced by a **squad limit of 27 players**, within which the school may fund whoever it chooses. In a sport where 12 awards previously had to be stretched across a whole squad, that is a genuine improvement — but the squad itself is now a fixed size. Division III offers no athletic scholarships, though academic and need-based aid is common, and all three divisions play for a national championship. See [the divisions](/guides/ncaa-divisions).

### Conferences and independents

Field hockey is geographically lopsided: the programmes cluster in the Northeast and Mid-Atlantic, where the sport is rooted in the school system. That has a consequence which confuses newcomers — because many conferences do not sponsor field hockey at all, several universities play their field hockey in **a different conference from the rest of their teams**, and a few play as independents with no conference at all. It is not a sign of a weak programme; it is a question of who has a team to play against.

The conference champion takes an automatic place in the NCAA tournament and the rest of the field is selected. One point in the sport's favour for an international player: travel distances are short by the standards of American college sport, and much of the season sits within a few hours' drive.

### The road to pro

There is no major professional field hockey league in the United States, and no draft. The route onward runs the opposite way to most sports: home to European club hockey — the Netherlands, England, Germany and Belgium have the strongest leagues — and on through the national team. College is therefore four years of hard competition and an American degree before a career continues in Europe, which is exactly why the field is so international.
...
Rugby's league structure does not follow a school's other conference affiliations, and that is the whole point: because the sport sits outside the NCAA on the men's side and is only an emerging sport on the women's, it is played in rugby's own associations. NIRA's top division gathered 13 teams in 2025, while the men's sides are spread across National Collegiate Rugby's own conferences and divisions. A university can be a major name in college sport generally and a minor one in rugby — and the reverse.

That makes research matter more in rugby than in almost any other sport: the school's brand tells you very little about the standard of its rugby programme, and you have to look at the league and the results rather than the name.

### The road to pro

For women the route onward is clear enough: club rugby in England, France or New Zealand and from there the national team — and with sevens on the Olympic programme, the Games are a realistic target. For men, American college rugby is not an established feeder into the professional game, and the realistic route runs home to European club rugby.

Common to both: college gives four years of structured training and matches alongside a degree — and in a sport with short careers and frequent injuries, the degree is not a footnote.
...
Water polo is the most geographically concentrated sport in college athletics: the weight sits in California, where the sport is rooted in the school system, and most championships have ended up there for decades. The conference map reflects it — several teams outside the west coast play in water-polo-specific conferences rather than their school's main conference, simply because there are no opponents nearby.

One oddity: the NCAA runs a single combined championship across the divisions in water polo (a National Collegiate championship) rather than one per division. A Division II or III programme therefore competes in principle for the same title as the major Division I schools.
...
Fencing is an NCAA sport and an equivalency sport: awards are made in fractions and a full scholarship is rare. At the Division I schools that opted into the House settlement in 2025, the scholarship cap has given way to a **squad limit of 24 fencers**, within which the school may fund freely.

The number of programmes is small and concentrated, so competition for a place is hard — but precisely because the field is small and international, a European fencer of reasonable standard is a realistic recruiting target. Outside the settlement schools and in Division II the old rules apply; Division III offers no athletic scholarships. See [the divisions](/guides/ncaa-divisions).
...
Fencing's conference map is thin and does not follow a school's other affiliations: because so few universities sponsor programmes, teams compete in fencing's own associations and the season is mostly invitational meets. The NCAA runs a single combined championship across the divisions, in which men and women score towards the same team title — so a small school can in principle beat a large one.

### The road to pro

There is no professional fencing league. The route onward is the national team: World Cup events, the European and World Championships and the Olympics. College fencing appeals because it gathers daily training, a coach and frequent competition into a four-year block with a degree attached — something few European fencers can arrange at home, where the sport is largely club-based and self-funded.
...
Because the sport sits outside the NCAA, there are no ordinary conferences in squash. Teams are ranked nationally through the season and meet at a single team championship, where schools are placed in graded divisions by ranking rather than by geography or conference membership. A university's standing in college sport generally therefore tells you nothing about its squash programme — look at the ranking.
...
Esports has no conferences in the NCAA sense, because the sport sits outside the NCAA. Schools instead compete in the associations' own leagues and divisions — NECC and comparable bodies — with seasons built around individual titles rather than geography. A programme can therefore be a major name in one title and not exist at all in another.

That makes research essential: look at which titles the school actually fields teams in, and which league they play in, before judging an offer.

### The road to pro

Esports is the sport in this catalogue where college least resembles a pipeline: the best players typically turn professional as teenagers and bypass university altogether. College esports is therefore somewhere to compete at a high level while taking a degree — often in precisely the subjects the industry hires for. Careers are short, and that argument carries more weight here than in any other sport.
...
Softball is played in weekend series against conference opponents, and the conference tournament in May awards an automatic place in the NCAA postseason. The rest of the field is picked nationally, and geography counts heavily: programmes in the warm south play outdoors from February and build stronger records than northern schools still waiting on the weather. That is much of why the sport's centre of gravity sits in the south and southwest.

A few schools play as independents with no conference and have to assemble a schedule themselves.
...
Wrestling has its own conferences, and they do not necessarily follow a school's other affiliations — several universities wrestle in a different conference from the one their team sports play in, because not every conference sponsors the sport. The conference championships in February and March allocate places at the NCAA championship, but qualification is ultimately **individual and by weight class**: you wrestle your way into the national championship in your own class, and the team title is the sum of how far the individuals go.

That means a single strong wrestler can reach the NCAA championship from a programme that is nowhere near the top of the country.
...
Bowling is a small sport in NCAA terms and has a correspondingly thin conference map: several teams compete in bowling-specific associations rather than their school's main conference, and the season consists largely of invitational tournaments rather than fixed conference fixtures. Qualification for the championship therefore rests on results across the season and a national selection.

As in water polo, the NCAA runs a single combined championship across the divisions in bowling rather than one per division — small schools and large compete for the same title.
...
Because college sailing sits outside the NCAA, NCAA scholarship rules and squad limits do not apply. What support a sailor receives is the individual school's own affair, and in practice academic scholarships and need-based aid are the usual route rather than athletic awards.

That has a consequence worth planning around: the programmes sit largely at old, academically demanding universities with substantial financial aid, so grades and the application matter more to the finances than results on the water do.
...
The ICSA is divided into regional conferences — New England, Mid-Atlantic, South, Midwest and West — and the season revolves around them: qualification for the national championships runs through regional events rather than a nationwide regular season. The conference therefore has nothing to do with a school's other sporting affiliations; it follows the water.

### The road to pro

Professional sailing exists, but it is narrow and project-based — keelboat circuits, America's Cup campaigns and Olympic programmes rather than a league with contracts. The route onward from college therefore runs through the national team and the Olympic classes, or into professional racing through contacts. What college sailing offers in the meantime is one of the densest competitive environments in the sport: many regattas in a short season and daily training with a fleet few clubs can match.

### Worth knowing

Team racing — three boats a school against three others, where the point is to control the opposition's finishing positions rather than simply sail fast — is what surprises European sailors most. It barely exists at the same level in European racing, and it is tactically demanding in an entirely different way from fleet racing.
...
Rifle is an NCAA sport, and its scholarships follow the NCAA's equivalency model — divided into fractions, with full awards rare. The number of programmes is small, so there are few places in total, but the field is international and readily recruits European shooters with ISSF results.

**Pistol, by contrast, is not an NCAA sport**, and no NCAA scholarship rules apply there; support depends on the individual school. The difference between the two disciplines is therefore not only sporting — it determines which rulebook the money follows. See [the divisions](/guides/ncaa-divisions).
...
Rifle has its own conferences, which do not follow a school's other affiliations, and the season consists of matches and invitationals rather than a conference fixture list. The NCAA runs a single combined championship across the divisions — and, as noted, men and women compete for the same titles, which is unique in American college sport.

### The road to pro

There is no professional shooting league. The route onward is the national team and the ISSF circuit, with the European and World Championships, World Cups and the Olympics as targets. College rifle fits that unusually well, because the disciplines — air rifle and smallbore — are the same ones shot internationally, and because four years of daily training with a full-time coach is hard to fund any other way.
...
Skiing has its own regional conferences — east and west — because geography decides everything in a sport that needs snow and altitude. Qualification for the NCAA championship runs through regional meets, and the NCAA holds a single combined championship in which alpine and nordic, men and women, all score towards the same team title. A programme without both disciplines cannot win it.

### The road to pro

The route onward is the national team and the World Cup circuit — there is no other professional structure in skiing. For many European skiers college works as an alternative to betting everything on a national-team place at nineteen: four years of training, competition and a degree, without closing the career down.
...
Triathlon is one of the NCAA's emerging sports for women — a recognised route towards a full championship — and its scholarships follow the NCAA's equivalency model, meaning partial shares rather than full awards. **For men the sport does not exist in the NCAA**, and a male triathlete has to look elsewhere, typically to a university's club programme with no athletic funding.
...
The route onward is the national team and the World Triathlon circuit, with the Olympics as the major target, or the professional long-course scene. College triathlon appeals because it gathers a pool, a cycling coach and a running programme in one place, with physiotherapy and strength training attached — infrastructure a young triathlete otherwise has to assemble and pay for alone.

### Worth knowing

Triathlon shares emerging-sport status with rugby, equestrian and flag football. Since 1994 eight sports have gone the whole way from emerging sport to a full NCAA championship, so the status is a beginning rather than a dead end.
...
There are no conferences in the NCAA sense in polo, because the sport sits outside the NCAA. The United States Polo Association instead divides collegiate teams into regions, and the season builds towards regional qualifying and from there a national championship. The structure follows the sport's own geography and has nothing to do with the conference a school's other teams play in.

### The road to pro

Professional polo is a small, network-driven world built around clubs and private teams rather than leagues with contracts. College polo is not a formal pipeline into it, but it is one of the few places where a player can compete often and at a decent standard without keeping horses — and for that reason a place where players get seen.

### Worth knowing

College polo is played as **arena polo**: three a side in an enclosed arena with a larger, softer ball, rather than four a side on an outdoor grass field. It is a faster, more compact version of the sport and substantially cheaper to run — which is the whole reason it could become a university sport.
...
Because the sport is so new, its conference map is still being built: several schools compete in temporary or sport-specific associations, and the season is built largely around tournaments rather than a fixed conference schedule. That is exactly what an emerging sport looks like — the structure arrives after the teams.

It also makes the sport easier to get into: a new programme has no twenty-year recruiting network to compete against.

### The road to pro

The big news for the sport is not professional: **flag football is on the Olympic programme at the Los Angeles Games in 2028**, and in a few years that has changed its status from a playground variant to a national-team discipline. The route onward for a European player therefore runs through the national team and international championships — and an American college programme is now among the best places to train towards it.
...
Collegiate cycling covers four disciplines, each with its own season and its own logic: road in the spring, with time trials, road races and criteriums; track, where there are velodromes; mountain bike in the autumn; and cyclocross in the winter. Points from individual races add up to a team score, so a broad squad scoring across disciplines beats a team with a single star.
...
USA Cycling divides collegiate teams into regional conferences, and the season revolves around them: you race against the schools in your own region and qualify from there for the national championships. The conference has nothing to do with a school's other sporting affiliations — it follows geography and discipline.

### The road to pro

The route into professional cycling does not run through American college — it runs through European continental and development teams, as it always has. College cycling is therefore for most riders a place to race and keep condition alongside a degree, not a staging post. That is worth being honest about before choosing the route on sporting grounds alone.
...
Archery has no conferences in the NCAA sense, since it is not an NCAA sport. Teams compete in the sport's own collegiate structure, with indoor and outdoor seasons and a national championship in each. A university's conference membership in the major sports therefore tells you nothing about where, or against whom, its archers shoot.

### The road to pro

There is no professional archery league. The route onward is the national team and the World Archery circuit, with the European and World Championships and the Olympics as targets. The strongest American college programmes train directly for the disciplines shot internationally and can therefore work as a four-year elite block with a degree attached — but only if you pick one of the few programmes where that is true.

### Worth knowing

Archery is one of the sports where American college varies most from place to place: at some schools it is a fully built competitive programme with daily training, at others a recreational club. Ask about the coach's background and which competitions the team actually travels to.
...
Acrobatics and tumbling is a spring sport. The season runs from January to April and is settled at a national championship in late spring. A meet is built in six events — compulsory, acro, pyramid, toss, tumbling and finally the team routine — with each element scored by judges and the team total accumulating through the meet.
...
The conference structure is young and still forming, as you would expect of a sport only now made an NCAA championship sport: several teams compete in sport-specific associations rather than their school's main conference, and the season is built around meets. With championship status the structure will probably come to resemble the other sports' over the next few years.

### The road to pro

There is no professional league in acrobatics and tumbling — the sport was born in the college system and has no professional tier above it. That makes college the top of the sport rather than a step towards something else, which is an unusual and in its way attractive position: you compete at the highest level that exists while studying. Many participants come from cheerleading or gymnastics and find here a competitive format that rewards exactly that background.
...
USA Ultimate divides teams into regions and sections, and the season builds through a qualifying series from there to the national championships in the spring. The structure follows the sport's own geography and has nothing to do with a school's conference — a university can be a power in ultimate and a nobody in everything else.

### The road to pro

Professional ultimate leagues exist in North America, but they are small and few players live on the sport. The route onward runs in practice through club teams and the national team to international championships. For many players college is the highest level they will reach.

### Worth knowing

Ultimate is played **without referees**, including at the highest college level: the players officiate themselves, under a principle called Spirit of the Game, and disputes are resolved on the field between the players involved. It is the sport's most distinctive feature and what surprises newcomers most — national championships included.
