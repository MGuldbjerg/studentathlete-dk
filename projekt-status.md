...
**BEVIDST IKKE OVERSAT — og det er en redaktionel beslutning, ikke dovenskab:** de 13 viden-guider (29.706 tegn) og 13 sport-pillartekster (26.906 tegn) er fulde af DANMARKS-specifikke fakta — gymnasiet, danske karakterer, danske NCAA-navne (Morten Andersen, Inge Nissen …). En ordret oversættelse ville være direkte forkert for britiske læsere, som skal have A-levels/GCSE/UCAS og britiske navne. De skal **skrives om**, ikke oversættes. Indtil da har UK-sitet ingen /viden-guider og ingen sport-pillartekster (siderne falder tilbage til kodens danske default — tjek dette før launch).
