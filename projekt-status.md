...
7. **`IDEA-laering.md`**: pitch for selvlærende sprog — edit-mining af original_content↔content-diffs → stilguide-forslag (godkend/afvis), lærte husregler i prompten, few-shot fra uredigerede guldartikler; KPI = % publiceret uredigeret (samme tal som auto-publish-gaten). Ikke bygget.
